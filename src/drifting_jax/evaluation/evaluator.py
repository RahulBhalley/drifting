...
from drifting_jax.logging import log_for_0
from drifting_jax.data.datasets import epoch0_sampler
from drifting_jax.distributed import pad_and_merge, ddp_shard
from drifting_jax.env import IMAGENET_FID_NPZ, IMAGENET_PR_NPZ
...
def _build_jax_inception(batch_size=200):
    ...
    from drifting_jax.evaluation import inception, resize
    from drifting_jax.evaluation.weights import load_all as load_inception_params
...
def _compute_stats(samples_uint8: np.ndarray, num_samples: int, *, compute_logits: bool, compute_features: bool, masks=None):
    ...
    for i in range(0, len(samples_uint8), full_batch):
        ...
        from drifting_jax.evaluation import resize
...
def evaluate_fid(
    ...
    """
    from drifting_jax.evaluation.frechet import compute_frechet_distance
    from drifting_jax.evaluation.precision_recall import compute_precision_recall
