...
from drifting_jax.models.hf import load_jax_ema_params, read_metadata
...
def load_init_entry(
    ...
    *,
    ...
    if model_type == "mae":
        from drifting_jax.models.mae import load_mae_hf
    ...
    if model_type == "generator":
        from drifting_jax.models.generator import load_hf
...
def load_generator_model_and_params(
    ...
    *,
    ...
    from drifting_jax.models.generator import build_generator_from_config
