...
from drifting_jax.checkpointing.initialize import load_init_entry, put_like
    ...
    def __call__(
        ...
        *,
        ...
        if mask is None:
            ...
            mask = jnp.asarray(mask, dtype=self.dtype)
            expected_shape = (*x.shape[:3], 1)
...
def load_mae_hf(
    ...
    *,
    ...
    """
    from drifting_jax.models.hf import load_mae_jax
...
def build_feature_model_and_params(
    ...
    if use_convnext:
        from drifting_jax.models.convnext import load_convnext_jax_model
    ...
    from drifting_jax.distributed import init_model_distributed
